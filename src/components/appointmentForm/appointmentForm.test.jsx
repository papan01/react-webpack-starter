...
describe('AppointmentForm', () => {
  ...
  describe('service field', () => {
    ...
    it('intitially has a blank value chosen', () => {
      render(<AppointmentForm />);
    ...
    it('saves existing value when submitted', async () => {
      ...
      render(<AppointmentForm service="Blow-dry" onSubmit={({ service }) => expect(service).toEqual('Blow-dry')} />);
      await ReactTestUtils.Simulate.submit(form('appointment'));
    });

    it('saves new value when submitted', async () => {
      expect.hasAssertions();
      render(<AppointmentForm service="Blow-dry" onSubmit={({ service }) => expect(service).toEqual('Cut')} />);
  ...
  describe('time slot table', () => {
    ...
    it('renders a week of available dates', () => {
      const t = new Date(2018, 11, 1);
      render(<AppointmentForm today={t} />);
